...
function InstagramIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" {...props}>
      <path
        fill="currentColor"
        d="M12 7.35a4.65 4.65 0 1 0 0 9.3 4.65 4.65 0 0 0 0-9.3Zm0 7.65a3 3 0 1 1 0-6 3 3 0 0 1 0 6ZM16.7 6.2a1.1 1.1 0 1 0 2.2 0 1.1 1.1 0 0 0-2.2 0Z"
      />
      <path
        fill="currentColor"
        d="M7.3 2h9.4A5.3 5.3 0 0 1 22 7.3v9.4A5.3 5.3 0 0 1 16.7 22H7.3A5.3 5.3 0 0 1 2 16.7V7.3A5.3 5.3 0 0 1 7.3 2Zm9.4 1.6H7.3A3.7 3.7 0 0 0 3.6 7.3v9.4a3.7 3.7 0 0 0 3.7 3.7h9.4a3.7 3.7 0 0 0 3.7-3.7V7.3a3.7 3.7 0 0 0-3.7-3.7Z"
      />
    </svg>
  )
}
...
function LinkedInIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" {...props}>
      <path
        fill="currentColor"
        d="M4.98 3.5a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 0 1 0-4.5ZM3.75 9h2.46v11.25H3.75V9ZM9.09 9h2.35v1.54h.03c.33-.6 1.13-1.54 2.92-1.54 3.12 0 3.7 2.05 3.7 4.72v6.53h-2.46v-5.8c0-1.38-.03-3.16-1.93-3.16-1.94 0-2.24 1.51-2.24 3.06v5.9H9.09V9Z"
      />
    </svg>
  )
}
...
function FacebookIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" {...props}>
      <path
        fill="currentColor"
        d="M22 12.06C22 6.55 17.52 2.1 12 2.1 6.48 2.1 2 6.55 2 12.06c0 4.98 3.66 9.11 8.44 9.86v-6.98H7.9v-2.88h2.54v-2.2c0-2.5 1.49-3.89 3.77-3.89 1.09 0 2.23.2 2.23.2v2.45h-1.25c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.44 2.88h-2.34v6.98C18.34 21.17 22 17.04 22 12.06Z"
      />
    </svg>
  )
}
...
> = {
  ...
  el: {
    ...
    intro: 'Πείτε μας λίγα για το έργο ή τις απορίες σας. Απαντάμε μέσα σε 1–2 εργάσιμες ημέρες.',
        ...
        <div className="splitLeft panel infoPanel" data-reveal="left" style={base120}>
          ...
          <ul className="infoList">
            <li className="reveal-child" style={i(2)}>
              ...
              <a href="tel:+34613497305" aria-label="+34 613 49 73 05 phone">
                +34 613 49 73 05
              </a>
            </li>
            <li className="reveal-child" style={i(3)}>
              <span className="label">{t.emailLabel}</span>
              <a href="mailto:hello@e-nutritionist.com">info@e-nutritionist.com</a>
            </li>
          </ul>

          <h3 className="h3 reveal-child" style={i(4)}>
            {t.socialsTitle}
          </h3>
          <div className="socials">
            <a
              ...
              style={i(5)}
              href="https://www.instagram.com/the_enutritionist/"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="splitRight panel formPanel" data-reveal="right" style={base160}>
          <form onSubmit={handleSubmit} noValidate className="form">
            ...
            {errors.name && (
              <span
                id="cf-name-error"
                className="fieldError reveal-child"
                style={i(1)}
                role="alert"
              >
                {errors.name}
