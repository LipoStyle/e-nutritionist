...
//   },
// }
// src/app/[lang]/contact/translations.ts
export const contactHeroTranslations = {
  en: {
  ...
  es: {
    ...
    message: '¿Listo para empezar tu camino?',
    bookText: 'Reservar consulta',
    ariaLabel: 'Hero de la página de contacto',
  },
  el: {
    description: 'Ας χτίσουμε κάτι εξαιρετικό μαζί.',
    message: 'Έτοιμοι να ξεκινήσουμε;',
    bookText: 'Κλείστε ραντεβού',
    ariaLabel: 'Hero ενότητας επικοινωνίας',
  },
} as const
