        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Comprehensive nutrition consulting tailored to your unique needs
              and goals
            </p>
          </div>
          ...
          <div className="text-center">
            <Button
              size="lg"
              className="gradient-accent text-white btn-modern shadow-medium"
              asChild
            >
              <Link to="/services">
                View All Services
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                With over 10 years of experience in sports nutrition and
                athletic performance, I specialize in helping athletes and
                active individuals optimize their nutrition for peak performance
      ...
      <section className="py-20 bg-accent-light/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Stay updated with the latest research, tips, and strategies for
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Delicious, nutritious recipes designed for optimal performance and
              health
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-xl text-white/90">
              ...
              optimal health and performance. Let's create a personalized
              nutrition plan that works for your lifestyle and goals.
            </p>
